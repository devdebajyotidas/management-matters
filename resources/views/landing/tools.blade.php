...
<!-- Mirrored from www.inventheme.com/themeforest/appway/appway/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Sep 2018 02:41:17 GMT -->
...
<head>
    ...
    <style type="text/css">
        ...
        .badge_tool {
            ...
            background-color: #f35d38 !important;
        }
        ...
        .feature-box-01 {
            border: none;
            box-shadow: var(--theme-shadow-y-15);
        }
...
<body data-spy="scroll" data-target="#navbar" data-offset="98">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li><a class="nav-link activated" href="{{url('/tools')}}">Tools</a></li>
                ...
                <div class="row justify-content-center">
                            ...
                            <div class="feature-box-01">
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific coaching experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Master</li>
                                        <li>Testing  your knowledge with a short Quiz</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="feature-box-01">
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific communication experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="feature-box-01">
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific disciplinary experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’t</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                                    </ul>
                                </div>
                            ...
                            <div class="feature-box-01">
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific generational workforce experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon green">
                                    <img src="{{asset('assets/images/tools/integrating-change.png')}}">
                                </div>
                                <h4><a href="#">Integrating Change</a></h4>
                                <div class="fix_height">
                                    <p>NEED INFO</p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon red">
                                    <img src="{{asset('assets/images/tools/meetings.png')}}">
                                </div>
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific effective meeting experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon blue">
                                    <img src="{{asset('assets/images/tools/motivation.png')}}">
                                </div>
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific motivational experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon red">
                                    <img src="{{asset('assets/images/tools/performance-management.png')}}">
                                </div>
                                <h4><a href="#">Performance Management and Goal Setting</a></h4>
                                <div class="fix_height">
                                    <p>NEED INFO</p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon blue">
                                    <img src="{{asset('assets/images/tools/problem-solving.png')}}">
                                </div>
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific problem solving experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon green">
                                    <img src="{{asset('assets/images/tools/remote-supervising.png')}}">
                                </div>
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific remote supervising experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon blue">
                                    <img src="{{asset('assets/images/tools/time-management.png')}}">
                                </div>
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific time management experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
                    ...
                    <div class="col-md-4">
                        <div class="card m-15px-tb">
                            <div class="feature-box-01">
                                <div class="icon red">
                                    <img src="{{asset('assets/images/tools/trust.png')}}">
                                </div>
                                ...
                                <div class="fix_height">
                                    ...
                                    <ul class=''>
                                        ...
                                        <li>Understanding specific trust building experiences and responses</li>
                                        <li>Creating Actionable activities and monitor progress on the Ticket Board</li>
                                        <li>Having  access to the Do’s and Don’ts</li>
                                        <li>Understanding the case studies presented as Management Monsters and Masters</li>
                                        <li>Testing your knowledge with a short Quiz</li>
    ...
    <script src="{{asset('assets/js/jquery.mintScrollbar.min.js')}}"></script>
...
<!-- Mirrored from www.inventheme.com/themeforest/appway/appway/index-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Sep 2018 02:41:21 GMT -->
</html>