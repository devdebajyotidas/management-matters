    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar" style="height: 100%;">
        <ul class="nav" id="side-menu">
            @if(session('role')=="admin")
                ...
                <li @if($page=='assessments') class="tab-current" @endif><a href="{{url('/assessments')}}" class="waves-effect"> <i class="sticon ti-agenda"></i><span class="hide-menu">Assessments</span></a></li>
                ...
                <li @if($page=='learnings') class="tab-current" @endif>
                    <a href="javascript:void(0)" class="waves-effect"><i class="sticon ti-blackboard"></i> <span class="hide-menu">Learning Modules<span class="fa arrow"></span></span></a>
                ...
                <li @if($page=='awards') class="tab-current" @endif><a href="{{url('/awards')}}" class="waves-effect"><i class="sticon ti-crown"></i><span class="hide-menu">Awards</span></a></li>
            @elseif(session('role')=="organization")
                <li @if($page=='dashboard') class="tab-current" @endif><a href="{{url('/dashboard')}}" class="waves-effect"><i class="sticon ti-home"></i> <span class="hide-menu">Dashboard</span></a></li>
                <li @if($page=='assessments') class="tab-current" @endif><a href="{{url('/assessments')}}" class="waves-effect"><i class="sticon ti-agenda"></i> <span class="hide-menu">Assessments</span></a></li>
                <li @if($page=='learnings') class="tab-current" @endif>
                    <a href="{{url('/learnings')}}" class="waves-effect"><i class="sticon ti-blackboard"></i> <span class="hide-menu">Learning Modules</span></a>
                </li>
