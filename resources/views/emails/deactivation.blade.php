                    ...
                    <tr>
                        <td class="wrapper">
                            <table border="0" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td>
                                        <h3 style="color:#13c482">Account Removed</h3>
                                        <p>Hi {{isset($name) ? $name : 'user'}}, Your account has been removed by the admin as per your request.If you haven't requested please contact your admin</p>
